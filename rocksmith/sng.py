...
RECT = Struct("y0" / Float32l, "x0" / Float32l, "y1" / Float32l, "x1" / Float32l)
...
SNG = Struct(
    ...
    "newLinkedDiffs" / array("levelBreak" / Int32sl, "nld_phrase" / array(Int32ul)),
    "actions" / array("time" / Float32l, "name" / PaddedString(256, encoding="ascii")),
    "events" / array("time" / Float32l, "name" / PaddedString(256, encoding="ascii")),
    "tone" / array("time" / Float32l, "id" / Int32ul),
    "dna" / array("time" / Float32l, "id" / Int32ul),
    "sections"
    / array(
        "name" / PaddedString(32, encoding="utf8"),
        "number" / Int32ul,
    ...
    / array(
        ...
        "anchor_extensions" / array("time" / Float32l, "fret" / Int8sl, Padding(7)),
        "fingerprints"
        / array(
            "chordId" / Int32ul,
            "startTime" / Float32l,
